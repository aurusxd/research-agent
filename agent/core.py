...

    {
        ...
        "function": {
            ...
            "description": (
                ...
                "как информация проверена через web_search. Не вызывай, "
                "если не найден хотя бы один канал связи: email, "
                "официальная форма, VK, Telegram или Одноклассники. Всегда "
                "заполняй preferred_channel и адрес выбранного получателя. "
                "Считай страницу contact_form только если на ней есть "
                "интерактивное поле сообщения и кнопка отправки. Если на "
                "странице указан только email, выбирай канал email."
            ),
